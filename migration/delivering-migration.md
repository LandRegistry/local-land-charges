...
show_home_link: true
back_link_location: /local-land-charges/migration/
---
...
<ol class='bold-big-numbers'>
  ...
  <li class='numbered-item'>
    ...
    <p>All relevant data sources are identified and the requirement for any scanning or digitisation of non-digital records can be included in the delivery plan.</p>
    <p>The quality and completeness of the data identified during discovery will help inform the development of the delivery plan.</p>
    <p>Helps the local authority plan their resources to meet the delivery timeline.</p>
  </li>
  ...
  <li class='numbered-item'>
    ...
    <p>It’s worth noting that these checks are run independently of the Migration Delivery team to ensure they are completely impartial and objective.</p>
  </li>
